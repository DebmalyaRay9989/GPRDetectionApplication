...
.gpr-head-title { font-size:1.5rem; font-weight:700; color:#f0f0f0; margin:0; letter-spacing:.4px; }
.gpr-head-sub   {
...
with tab_guide:
    ...
    with c1:
        ...
        <div class='card card-lo'>
            ...
            3. Adjust <b style='color:#e0e0e0'>Confidence</b> &amp; <b style='color:#e0e0e0'>Overlap</b> in the sidebar<br>
            4. Click <b style='color:#e0e0e0'>RUN INFERENCE</b><br>
            5. Review the annotated output, detection cards &amp; table<br>
            6. Use <b style='color:#e0e0e0'>⬇ Download</b> buttons to export image or CSV<br>
            7. Use <b style='color:#e0e0e0'>Batch Analysis</b> for multiple scans at once
            </div>
        </div>
        <div class='card'>
